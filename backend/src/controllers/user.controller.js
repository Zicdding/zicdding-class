...
import { generateRefreshToken, generateToken, replaceAccessToken, saveRefreshToken } from '../utils/jwt';
...
const process = {
  ...
  replaceToken: (req, res) => {
    ...
    if (!refreshToken) return res.send(setResponseJson(res, 403, '리프레시 토큰 만료'));
